...
const UpdateRemainStock = ({ closeModal }: { closeModal: () => void }) => {
    ...
    const handleUpdateStock = async () => {
        try {
            ...
            const totalNoCupsPerDayType500ml = noGlassInDay.cups500ml + deliveryMore.cups500ml;
            const totalNoCupsPerDayType700ml = noGlassInDay.cups700ml + deliveryMore.cups700ml;
            const totalNoCupsPerDayType800ml = noGlassInDay.cups800ml + deliveryMore.cups800ml;
